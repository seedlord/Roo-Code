...
export const codeActionIds = ["explainCode", "fixCode", "improveCode", "addToContext", "startNewTask"] as const

export type CodeActionId = (typeof codeActionIds)[number]

export type CodeActionName = "EXPLAIN" | "FIX" | "IMPROVE" | "ADD_TO_CONTEXT" | "START_NEW_TASK"
